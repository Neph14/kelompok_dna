...
import com.example.litera.data.local.BukuCartDao
import com.example.litera.databinding.ActivityCartBinding
    ...
    private fun tampilkanDialogSukses() {
        androidx.appcompat.app.AlertDialog.Builder(this@CartActivity)
            ...
            .setPositiveButton("OK") { _, _ ->
                val intent = Intent(this@CartActivity, com.example.litera.MainActivity::class.java).apply {
